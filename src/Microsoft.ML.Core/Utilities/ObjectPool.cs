...
{
    [BestFriend]
    /*internal*/public sealed class ObjectPool<T> : ObjectPoolBase<T> where T : class, new()
    {
    ...
    [BestFriend]
    /*internal*/public sealed class MadeObjectPool<T> : ObjectPoolBase<T>
    {
    ...
    /*internal*/public abstract class ObjectPoolBase<T>
    {
